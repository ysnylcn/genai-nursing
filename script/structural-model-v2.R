...
model <- readLines("model/structural-model-v2.txt")
...
path_coef$Hypothesis[path_coef$lhs == "BI" & path_coef$rhs == "PU"]  <- "H1"
path_coef$Hypothesis[path_coef$lhs == "BI" & path_coef$rhs == "PEU"] <- "H2"
path_coef$Hypothesis[path_coef$lhs == "BI" & path_coef$rhs == "SN"]  <- "H3"
...
output_file <- "output/structural-model-v2-results.xlsx"
